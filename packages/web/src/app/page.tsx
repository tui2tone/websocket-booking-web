  ...
  return (
    <div>
      ...
      <div className="relative">
        <div className="absolute z-0 top-0 left-0 right-0 bottom-0 bg-cover bg-center" style={{ backgroundImage:"url(/images/bg-heading-1.jpg)" }} ></div>
        <div className="absolute z-1 top-0 left-0 right-0 bottom-0 opacity-80" style={{
